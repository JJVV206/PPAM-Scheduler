                ...
                {state.expanded ? (
                  <div className="mt-4 space-y-4 border-t border-border/60 pt-4">
                    {state.available ? (
                        ...
                        {state.useSpecificSlots ? (
                          <div className="grid gap-2 sm:grid-cols-5">
                            {TIME_SLOTS.map((timeSlot) => (
                              <label
                                key={timeSlot}
                                className="flex items-center gap-2 rounded-lg border border-border/70 bg-background/40 px-3 py-2 text-sm"
                              >
                                <Checkbox
                      ...
                      <p className="rounded-lg bg-background/50 px-3 py-2 text-sm text-muted-foreground">
