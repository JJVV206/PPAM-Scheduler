...
>(({ className, ...props }, ref) => (
  <thead
    ref={ref}
    className={cn(
      "bg-surface-elevated/40 [&_tr]:border-b [&_tr]:border-border/70",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <tfoot
    ref={ref}
    className={cn(
      "border-t border-border/60 bg-secondary/20 font-medium [&>tr]:last:border-b-0",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <tr
    ref={ref}
    className={cn("transition-colors hover:bg-secondary/35", className)}
    {...props}
  />
));
